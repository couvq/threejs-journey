...
/**
 * another shadow strategy is to basically have a static shadow that changes its position
 * with the object it represents a shadow for
 */
...
const tick = () => {
  ...
  // update the sphere with it's shadow

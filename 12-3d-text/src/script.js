...
fontLoader.load("/fonts/helvetiker_regular.typeface.json", (font) => {
  const textGeometry = new TextGeometry("Quentin Couvelaire", {
    font: font,
    size: 0.5,
    height: 0.2,
    curveSegments: 5,
  ...
  // optimized our rendering, went from ~24ms to paint 100 donuts vs now ~1ms.
  // we can just reuse the geometry and material since they are the same
